...
from bag.tools import DotDict, lazy
from bag.tools.translate import translate_sql_constraint
...
def execute_cr(cr, uid, obj, method, *args, **kw):
    ...
    result = retrying(partial(bag.api.call_kw, recs, method, args, kw), env)
...
def retrying(func, env):
    ...
    :param bag.api.Environment env: The environment where the registry
