...
Bag will use the SQL function 'unaccent' when available for the
...
import bag.modules
from bag.models import check_property_field_value_name, READ_GROUP_NUMBER_GRANULARITY
from bag.tools import Query, SQL, get_lang
from bag.tools.sql import pattern_to_translated_trigram_pattern, value_to_translated_trigram_pattern
...
def get_unaccent_wrapper(cr):
    ...
    return bag.modules.registry.Registry(cr.dbname).unaccent
