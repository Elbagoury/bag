...
from bag.addons.test_mail.models.test_mail_corner_case_models import MailTestMultiCompanyWithActivity
from bag.addons.test_mail.tests.common import TestRecipients
from bag.exceptions import AccessError
from bag.tests import tagged, users, HttpCase
...
class TestMultiCompanySetup(TestMailMCCommon, HttpCase):
    ...
    @users('employee_c2')
    @mute_logger('bag.addons.base.models.ir_rule')
            ...
            with self.subTest(login=login, mc_record=mc_record):
                ...
                if not login:
                    ...
                    if mc_error:
                        ...
                        self.assertEqual(parsed_url.path, '/bag/action-mail.action_discuss')
                    else:
