...
from bag.addons.base.tests.test_ir_cron import CronMixinCase
from bag.addons.mail.tests.common import mail_new_test_user, MailCommon
from bag.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE_PLAINTEXT
from bag.addons.test_mail.models.test_mail_models import MailTestSimple
from bag.addons.test_mail.tests.common import TestRecipients
from bag.api import call_kw
from bag.exceptions import AccessError
from bag.tests import tagged
from bag.tools import mute_logger, formataddr
from bag.tests.common import users
...
class TestMessageNotify(TestMessagePostCommon):
    ...
    @users('employee')
    @mute_logger('bag.addons.mail.models.mail_mail', 'bag.models.unlink', 'bag.tests')
...
class TestMessagePost(TestMessagePostCommon, CronMixinCase):
    ...
    @mute_logger('bag.addons.mail.models.mail_mail', 'bag.models.unlink')
    @users('employee')
    ...
    def test_message_post_inactive_follower(self):
        """ Test posting with inactive followers does not notify them (e.g. bagbot) """
        test_record = self.env['mail.test.simple'].browse(self.test_record.ids)
                ...
                with self.assertSinglePostNotifications(
                        ...
                        message_info={
                            ...
                            'mail_mail_values': {
                                'headers': {
                                    'Return-Path': f'{expected_alias_domain.bounce_alias}@{expected_alias_domain.name}',
                                    'X-Bag-Objects': f'{record._name}-{record.id}',
                                },
                            },
                            'message_values': {
    ...
    @mute_logger('bag.addons.mail.models.mail_mail', 'bag.tests')
    ...
    @users('employee')
    @mute_logger('bag.addons.mail.models.mail_mail', 'bag.addons.mail.models.mail_message_schedule', 'bag.models.unlink')
    ...
    @mute_logger('bag.addons.mail.models.mail_mail', 'bag.addons.mail.models.mail_message_schedule')
    ...
    @mute_logger('bag.addons.base.models.ir_model', 'bag.addons.mail.models.mail_mail')
