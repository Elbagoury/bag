...
from bag.addons.mail.wizard.mail_compose_message import MailComposer
from bag.addons.test_mail.models.test_mail_models import MailTestTicket
from bag.addons.test_mail.tests.common import TestRecipients
from bag.fields import Datetime as FieldDatetime
from bag.exceptions import AccessError, UserError
from bag.tests import Form, tagged, users
from bag.tools import email_normalize, mute_logger, formataddr
...
class TestComposerInternals(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('bag.tests', 'bag.addons.mail.models.mail_mail', 'bag.models.unlink')
    ...
    @mute_logger('bag.tests', 'bag.addons.base.models.ir_rule', 'bag.addons.mail.models.mail_mail', 'bag.models.unlink')
...
class TestComposerResultsComment(TestMailComposer, CronMixinCase):
    ...
    @users('employee')
    @mute_logger('bag.models.unlink', 'bag.addons.mail.models.mail_mail', 'bag.addons.mail.models.mail_message_schedule')
...
class TestComposerResultsMass(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('bag.models.unlink', 'bag.addons.mail.models.mail_mail')
