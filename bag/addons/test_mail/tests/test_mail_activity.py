...
from bag import fields, exceptions, tests
from bag.addons.mail.tests.common import mail_new_test_user, MailCommon
from bag.addons.test_mail.models.test_mail_models import MailTestActivity
from bag.tests import Form, HttpCase, users
...
class TestActivityMixin(TestActivityCommon):
    ...
    def test_mail_activity_state(self):
        ...
        with patch('bag.addons.mail.models.mail_activity.datetime', MockedDatetime):
    ...
    def test_mail_activity_mixin_search_state_basic(self):
        ...
        with patch('bag.addons.mail.models.mail_activity.datetime', MockedDatetime), \
            patch('bag.addons.mail.models.mail_activity_mixin.datetime', MockedDatetime):
