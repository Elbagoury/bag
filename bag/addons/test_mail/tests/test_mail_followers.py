...
from bag.addons.mail.models.mail_mail import _UNFOLLOW_REGEX
from bag.addons.mail.tests.common import MailCommon
from bag.exceptions import AccessError
from bag.tools.misc import limited_field_access_token
from bag.tests import tagged, users
from bag.tests.common import HttpCase
from bag.tools import email_normalize, mail, mute_logger, parse_contact_from_email
...
class UnfollowFromEmailTest(MailCommon, HttpCase):
    ...
    @mute_logger('bag.addons.base.models', 'bag.addons.mail.controllers.mail', 'bag.http', 'bag.models')
    ...
    @mute_logger('bag.addons.mail.controllers.mail', 'bag.models', 'bag.http')
