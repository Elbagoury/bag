...
from bag.addons.base.tests.common import DISABLED_MAIL_CONTEXT
from bag.addons.website.tools import MockRequest
from bag.addons.website_sale.tests.common import WebsiteSaleCommon
from bag.addons.website_sale_loyalty.controllers.delivery import WebsiteSaleLoyaltyDelivery
