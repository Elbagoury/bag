...
from bag.tests import tagged, JsonRpcException
from bag.tools import mute_logger

from bag.addons.payment.controllers.portal import PaymentPortal
...
class TestFlows(PaymentHttpCommon):
    ...
    def test_transaction_wrong_flow(self):
        ...
        with mute_logger("bag.http"), self.assertRaises(
            JsonRpcException,
            msg='bag.exceptions.UserError: The payment should either be direct, with redirection, or made by a token.',
        ):
    ...
    def test_transaction_wrong_token(self):
        ...
        with mute_logger('bag.http'), self.assertRaises(JsonRpcException, msg='bag.exceptions.ValidationError: The access token is invalid.'):
    ...
    @mute_logger('bag.addons.payment.models.payment_transaction')
