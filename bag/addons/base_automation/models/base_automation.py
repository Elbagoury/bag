...
from bag import _, api, exceptions, fields, models
from bag.http import request
from bag.tools import DEFAULT_SERVER_DATETIME_FORMAT, safe_eval
...
class BaseAutomation(models.Model):
    ...
    def _get_filter_domain_fields(self):
        ...
        # see: https://github.com/bag/bag/pull/189772#issuecomment-2548804283
