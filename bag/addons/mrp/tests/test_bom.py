...
from bag import exceptions, Command, fields
from bag.tests import Form
from bag.addons.mrp.tests.common import TestMrpCommon
from bag.tests.common import HttpCase, tagged, freeze_time
from bag.tools import float_compare, float_round, float_repr
...
class TestBoM(TestMrpCommon):
    ...
    def test_cycle_on_bom_sequencing(self):
        ...
        # (see bag/addons/web/controllers/main.py:1352)
...
class TestTourBoM(HttpCase):
    ...
    def test_mrp_bom_product_catalog(self):
        ...
        url = f'/bag/action-mrp.mrp_bom_form_action/{self.bom.id}'
    ...
    def test_manufacture_from_bom(self):
        ...
        """
        url = '/bag/action-mrp.mrp_bom_form_action'
