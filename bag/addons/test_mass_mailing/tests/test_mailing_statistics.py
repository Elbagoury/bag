...
from bag.addons.test_mass_mailing.data.mail_test_data import MAIL_TEMPLATE
from bag.addons.test_mass_mailing.tests.common import TestMassMailCommon
...
class TestMailingStatistics(TestMassMailCommon):
    ...
    @mute_logger('bag.addons.mass_mailing.models.mailing', 'bag.addons.mail.models.mail_mail', 'bag.addons.mail.models.mail_thread')
    def test_mailing_statistics(self):
        ...
        self.gateway_mail_trace_click(mailing, target_records[0], 'https://www.bag.be')
        self.gateway_mail_trace_click(mailing, target_records[2], 'https://www.bag.be')
        self.gateway_mail_trace_click(mailing, target_records[3], 'https://www.bag.be')
