...
from bag.addons.website_sale_autocomplete.controllers.main import AutoCompleteController
from bag.tests import patch, HttpCase, tagged

CONTROLLER_PATH = 'bag.addons.website_sale_autocomplete.controllers.main.AutoCompleteController'
