...
from bag.exceptions import AccessDenied, AccessError, UserError
from bag.http import request
from bag.modules.module import adapt_version, MANIFEST_NAMES
from bag.osv.expression import is_leaf
from bag.release import major_version
from bag.tools import convert_csv_import, convert_sql_import, convert_xml_import, exception_to_unicode
from bag.tools import file_open, file_open_temporary_directory, ormcache

_logger = logging.getLogger(__name__)

APPS_URL = "https://apps.bag.com"
...
class IrModule(models.Model):
    ...
    def _import_module(self, module, path, force=False, with_demo=False):
        ...
        if unmet_dependencies:
            ...
            raise UserError(_("Studio customizations require the Bag Studio app."))
    ...
    def _get_missing_dependencies(self, zip_data):
        ...
        if unavailable_modules:
            ...
            description += _(
                ...
                "https://www.bag.com/pricing-plan for more information.\n"
                "If you need Website themes, it can be downloaded from https://github.com/bag/design-themes.\n"
            )
        else:
            description = _(
