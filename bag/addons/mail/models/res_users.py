...
from bag import _, api, Command, fields, models, modules, tools
...
class Users(models.Model):
    ...
    notification_type = fields.Selection([
        ...
        help="Policy on how to handle Chatter notifications:\n"
             ...
             "- Handle in Bag: notifications appear in your Bag Inbox")

    _sql_constraints = [(
        "notification_type",
        "CHECK (notification_type = 'email' OR NOT share)",
        "Only internal user can receive notifications in Bag",
    )]
        ...
        store.add(
            {
                ...
                # sudo: res.partner - exposing BagBot data is considered acceptable
                "bagbot": Store.one(self.env.ref("base.partner_root").sudo()),
            }
        )
