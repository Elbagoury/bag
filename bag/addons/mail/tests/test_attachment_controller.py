...
import bag
from bag.tools import file_open, mute_logger
from bag.addons.mail.tests.test_controller_common import TestControllerCommon
...
class TestAttachmentControllerCommon(TestControllerCommon):
    ...
    def _upload_attachment(self, thread_id, thread_model, route_kw):
        with mute_logger("bag.http"), file_open("addons/web/__init__.py") as file:
            res = self.url_open(
