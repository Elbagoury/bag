...
from bag.addons.base.models.ir_mail_server import IrMailServer
from bag.addons.base.tests.common import MockSmtplibCase
from bag.addons.bus.models.bus import ImBus, json_dump
from bag.addons.mail.models.mail_mail import MailMail
from bag.addons.mail.models.mail_message import Message
from bag.addons.mail.models.mail_notification import MailNotification
from bag.addons.mail.models.res_users import Users
from bag.addons.mail.tools.discuss import Store
from bag.tests import common, RecordCapturer, new_test_user
from bag.tools import mute_logger
from bag.tools.mail import (
    email_normalize, email_split_and_format_normalize, formataddr
)
from bag.tools.translate import code_translations
...
class MailCommon(common.TransactionCase, MailCase):
    ...
    def _activate_multi_lang(cls, lang_code='es_ES', layout_arch_db=None, test_record=False, test_template=False):
        ...
        with mute_logger("bag.addons.base.models.ir_module", "bag.tools.translate"):
