...
from bag.addons.base.tests.common import HttpCase, HttpCaseWithUserDemo
from bag.addons.mail.tests.common import MailCommon, mail_new_test_user
from bag.http import STATIC_CACHE_LONG
from bag import Command, fields, http
...
class TestMessageLinks(MailCommon, HttpCase):
    ...
    def test_message_link_by_employee(self):
        ...
        with self.subTest(channel_message=channel_message):
            expected_url = self.base_url() + f'/bag/action-mail.action_discuss?active_id={channel_message.res_id}&highlight_message_id={channel_message.id}'
