...
from bag.tests import tagged, new_test_user
from bag.addons.bus.tests.common import WebsocketCase
from bag.addons.mail.tests.common import MailCommon
from bag.addons.bus.models.bus import channel_with_db, json_dump
...
class TestBusPresence(WebsocketCase, MailCommon):
    def _receive_presence(self, sender, recipient):
        ...
        self.subscribe(
            websocket,
            [f"bag-presence-{sender_bus_target._name}_{sender_bus_target.id}"],
