...
from bag.addons.mail.tools import link_preview
...
class TestLinkPreview(MailCommon):
    ...
    def test_link_preview_ignore_internal_link(self):
        ...
        with patch.object(requests.Session, "get", self._patch_with_og_properties), patch.object(
            ...
            urls = [
                ("http://localhost:8069/", "http://localhost:8069/bag", 0),
                ("http://localhost:8069/", "http://localhost:8069/bag/test", 0),
                ("http://localhost:8069/", "http://localhost:8069/web/test", 0),
                ("http://localhost:8069/", "http://localhost:8069/", 1),
                ("http://localhost:8069/", "http://localhost:8069/bag-experience", 1),
                ("http://localhost:8069/", "http://localhost:8069/chat/5/bFtIfYHRco", 0),
                ("https://www.bag.com/", "https://www.bag.com/web", 0),
                ("https://www.bag.com/", "https://www.bag.com/bag", 0),
                ("https://www.bag.com/", "https://www.bag.com/bag/", 0),
                ("https://www.bag.com/", "https://www.bag.com/bag?debug=assets", 0),
                ("https://www.bag.com/", "https://www.bag.com/bag#anchor", 0),
                ("https://www.bag.com/", "https://www.bag.com/bag-experience", 1),
                ("https://www.bag.com/", "https://www.bag.com/bag/1519/tasks/4102866", 0),
                ("http://www.bag.com/", "https://www.bag.com/bag/1519/tasks/4102866", 1),
                ("https://www.bag.com/", "https://wwwabag.com/bag/", 1),
                ("https://www.bag.com/", "https://www.bag.com/chat/", 0),
                ("https://www.bag.com/", "https://www.bag.com/chat/5/bFtIfYHRco", 0),
                ("http://www.bag.com/", "https://www.bag.com/chat/5/bFtIfYHRco", 1),
                ("https://clients.bag.com/", "https://www.bag.com/bag/1519/tasks/4102866", 1),
                ("https://clients.bag.com/", "https://www.bag.com/chat/5/bFtIfYHRco", 1),
            ]
