/** @bag-module alias=@web/../tests/utils default=false */

import { __debug__, after, afterEach, expect, getFixture } from "@bag/hoot";
import { queryAll, queryFirst } from "@bag/hoot-dom";
 ...
 *  element.
 * @property {HTMLElement|BagEnv} [target=getFixture()]
...
class Contains {
    ...
    constructor(selector, options = {}) {
        ...
        if (this.options.target?.testEnv) {
            // when BagEnv, special key `target`. See @start
