...
import { after, before, expect, getFixture, registerDebugInfo } from "@bag/hoot";
import { hover as hootHover, queryFirst, resize } from "@bag/hoot-dom";
...
import { Component, onMounted, onPatched, onWillDestroy, status } from "@bag/owl";
