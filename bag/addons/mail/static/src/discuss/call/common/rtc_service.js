...
/**
 * @return {Promise<{ SfuClient: import("@mail/../lib/bag_sfu/bag_sfu").SfuClient, SFU_CLIENT_STATE: import("@mail/../lib/bag_sfu/bag_sfu").SFU_CLIENT_STATE }>}
 */
const loadSfuAssets = memoize(async () => await loadBundle("mail.assets_bag_sfu"));
...
export class Rtc extends Record {
    ...
    async _loadSfu() {
        const load = async () => {
            await loadSfuAssets();
            const sfuModule = bag.loader.modules.get("@mail/../lib/bag_sfu/bag_sfu");
