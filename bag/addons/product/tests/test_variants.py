...
from bag.tests import tagged, TransactionCase, Form
from bag.tools import mute_logger

from bag.addons.product.tests.common import ProductVariantsCommon, ProductAttributesCommon
...
class TestVariantsExclusion(ProductAttributesCommon):
    ...
    def test_dynamic_variants_unarchive(self):
        ...
        with patch(
            'bag.addons.product.models.product_product.ProductProduct._filter_to_unlink',
