...
from bag.tests.common import new_test_user, Like
from bag.tools import mute_logger
from bag.addons.test_http.utils import HtmlTokenizer
...
class TestHttpModels(TestHttpBase):
    ...
    def test_models5_stargate_setname_readonly(self):
        ...
        with self.assertLogs('bag.http', 'WARNING') as capture_http,\
             self.assertLogs('bag.sql_db', 'WARNING') as capture_sql_db:
