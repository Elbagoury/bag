...
import bag
from bag.tests import new_test_user, tagged, RecordCapturer
from bag.tools import config, file_open, image_process
from bag.tools.misc import submap
...
class TestHttpStaticLogo(TestHttpStaticCommon):
    ...
    def setUpClass(cls):
        ...
        super_user = cls.env['res.users'].browse([bag.SUPERUSER_ID])
