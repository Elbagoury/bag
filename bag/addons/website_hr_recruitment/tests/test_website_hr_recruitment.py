...
import bag.tests
from bag.tools import html2plaintext

from bag.addons.website.tools import MockRequest
from bag.addons.website_hr_recruitment.controllers.main import WebsiteHrRecruitment

@bag.tests.tagged('post_install', '-at_install')
class TestWebsiteHrRecruitmentForm(bag.tests.HttpCase):
    def test_tour(self):
        ...
        with bag.tests.RecordCapturer(self.env['hr.applicant'], []) as capt:
