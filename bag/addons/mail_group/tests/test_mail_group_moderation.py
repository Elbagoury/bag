...
from bag.addons.mail_group.tests.data import GROUP_TEMPLATE
from bag.addons.mail_group.tests.common import TestMailListCommon
...
class TestMailGroupModeration(TestMailListCommon):
    ...
    @mute_logger('bag.models.unlink', 'bag.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('bag.addons.base.models.ir_rule', 'bag.addons.base.models.ir_model')
...
class TestModeration(TestMailListCommon):
    ...
    @mute_logger('bag.addons.mail.models.mail_thread', 'bag.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('bag.addons.mail.models.mail_thread', 'bag.addons.mail_group.models.mail_group_message', 'bag.models.unlink')
    @users('employee')
    ...
    @mute_logger('bag.addons.mail_group.models.mail_group')
    @users('employee')
