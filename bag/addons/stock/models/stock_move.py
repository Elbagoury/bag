...
from bag import _, api, Command, fields, models
from bag.exceptions import UserError, ValidationError
from bag.osv import expression
from bag.tools.float_utils import float_compare, float_is_zero, float_round
from bag.tools.misc import clean_context, OrderedSet, groupby
...
Please change the quantity done or the rounding precision of your unit of measure.""",
    ...
    def _propagate_date_log_note(self, move_orig):
        ...
        for doc in documents:
            ...
            doc.message_post(body=msg, author_id=bagbot_id, subject=msg_subject)
