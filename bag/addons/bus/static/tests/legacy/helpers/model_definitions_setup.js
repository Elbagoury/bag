/** @bag-module alias=@bus/../tests/helpers/model_definitions_setup default=false */
...
insertRecords("res.users", [
    {
        ...
        display_name: "BagBot",
        login: "__system__",
        id: TEST_USER_IDS.bagbotUserId,
        name: "Public user",
        partner_id: TEST_USER_IDS.bagbotId,
    },
    {
