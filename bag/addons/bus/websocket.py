...
import bag
from bag import api, modules
from .models.bus import dispatch
from bag.http import root, Request, Response, SessionExpiredException, get_default_session
from bag.modules.registry import Registry
from bag.service import model as service_model
from bag.service.server import CommonServer
from bag.service.security import check_session
from bag.tools import config, lazy_property
...
class Websocket:
    ...
    def __init__(self, sock, session, cookies):
        ...
        self.__selector = (
            ...
            if bag.evented and hasattr(selectors, 'PollSelector')
