...
from bag.modules import get_modules, get_module_path
...
class TestPyLint(TransactionCase):
    ...
    def test_pylint(self):
        ...
        options = [
            ...
            '--load-plugins=pylint.extensions.bad_builtin,_bag_checker_sql_injection,_bag_checker_gettext,_bag_checker_unlink_override',
