...
from bag import Command, tests
from bag.addons.im_livechat.tests.chatbot_common import ChatbotCase
from bag.addons.website_livechat.tests.common import TestLivechatCommon as TestWebsiteLivechatCommon
