...
from bag.addons.test_event_full.tests.common import TestEventFullCommon
from bag.addons.website.tests.test_performance import UtilPerf
...
class TestOnlineEventPerformance(EventPerformanceCase, UtilPerf):
    ...
    #                 'bag.__DEBUG__.services["web_tour.tour"].run("wevent_performance_register")',
    #                 'bag.__DEBUG__.services["web_tour.tour"].tours.wevent_performance_register.ready',
    #                 login=None,
    #                 timeout=200,
    #             )
