...
from bag.addons.event_crm.tests.common import EventCrmCase
...
from bag.addons.sms.tests.common import SMSCase
from bag.addons.website.tests.test_website_visitor import MockVisitor
