import { Component, useState, whenReady } from "@bag/owl";
import { BagLogo } from "@point_of_sale/app/generic_components/bag_logo/bag_logo";
...
export class CustomerDisplay extends Component {
    ...
    static components = { BagLogo, OrderWidget, Orderline, MainComponentsContainer };
    static props = [];
    setup() {
