...
export class PosStore extends Reactive {
    ...
    async recordSynchronisation(data) {
        if (bag.debug === "assets") {
            ...
            console.info("Login number", bag.login_number, data.login_number);
            console.info("Session Ids", bag.pos_session_id, data.session_id);
        }

        if (data.login_number === bag.login_number || data.session_id !== bag.pos_session_id) {
            return;
        }
    ...
    async processServerData() {
        ...
        this.models["pos.session"].getFirst().login_number = parseInt(bag.login_number);
    ...
    redirectToBackend() {
        window.location = "/bag/action-point_of_sale.action_client_pos_menu";
    }
