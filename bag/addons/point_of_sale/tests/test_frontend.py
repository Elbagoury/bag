...
from bag.tools import DEFAULT_SERVER_DATE_FORMAT
from bag.tests import tagged
from bag.addons.account.tests.common import AccountTestInvoicingHttpCommon
from bag.addons.point_of_sale.tests.common_setup_methods import setup_product_combo_items
from datetime import date, timedelta
from bag.addons.point_of_sale.tests.common import archive_products
from bag.exceptions import UserError
from bag.addons.point_of_sale.models.pos_config import PosConfig
