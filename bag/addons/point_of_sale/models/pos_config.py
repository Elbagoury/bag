...
from bag import api, fields, models, _, Command, tools, SUPERUSER_ID
from bag.http import request
from bag.exceptions import AccessError, ValidationError, UserError
from bag.tools import convert, SQL
...
class PosConfig(models.Model):
    ...
    sequence_id = fields.Many2one('ir.sequence', string='Order IDs Sequence', readonly=True,
        help="This sequence is automatically created by Bag but you can change it "
