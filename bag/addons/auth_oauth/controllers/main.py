...
from bag import api, http, SUPERUSER_ID, _
from bag.exceptions import AccessDenied
from bag.http import request, Response
from bag import registry as registry_get
from bag.tools.misc import clean_context

from bag.addons.auth_signup.controllers.main import AuthSignupHome as Home
from bag.addons.web.controllers.utils import ensure_db, _get_login_redirect_url
...
class OAuthController(http.Controller):
    ...
    def signin(self, **kw):
        ...
        try:
            ...
            if redirect:
                ...
                url = '/bag/action-%s' % action
            elif menu:
                url = '/bag?menu_id=%s' % menu
    ...
    def oea(self, **kw):
        """login user via Bag Account provider"""
