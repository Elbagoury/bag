...
from bag import _, fields, models, service
from bag.exceptions import ValidationError

from bag.addons.payment_mollie import const
...
class PaymentProvider(models.Model):
    ...
    def _mollie_make_request(self, endpoint, data=None, method='POST'):
        ...
        bag_version = service.common.exp_version()['server_version']
        ...
        headers = {
            ...
            "User-Agent": f'Bag/{bag_version} MollieNativeBag/{module_version}',
        }
