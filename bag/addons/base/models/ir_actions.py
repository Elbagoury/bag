...
import bag
from bag import api, fields, models, tools, _, Command
from bag.exceptions import MissingError, ValidationError, AccessError, UserError
from bag.tools import frozendict
from bag.tools.safe_eval import safe_eval, test_python_expr
from bag.tools.float_utils import float_compare
...
class IrActionsServer(models.Model):
    ...
    Since Bag 8.0 a button 'Create Menu Action' button is available on the
...
# To return an action, assign: action = {...}\n\n\n\n"""
    ...
    def _get_eval_context(self, action=None):
        ...
        eval_context.update({
            ...
            'model': model,
            # Exceptions
            'UserError': bag.exceptions.UserError,
            # record
            'record': record,
            'records': records,
            # helpers
