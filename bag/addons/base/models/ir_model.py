...
from bag import api, fields, models, tools, Command
from bag.exceptions import AccessError, UserError, ValidationError
from bag.osv import expression
from bag.tools import format_list, lazy_property, sql, unique, OrderedSet, SQL
from bag.tools.safe_eval import safe_eval, datetime, dateutil, time
from bag.tools.translate import _, LazyTranslate
...
class IrModel(models.Model):
    ...
    def unlink(self):
        ...
        # reload is done independently in bag.modules.loading.
...
class IrModelConstraint(models.Model):
    """
    This model tracks PostgreSQL foreign keys and constraints used by Bag
    models.
    """
...
class IrModelRelation(models.Model):
    """
    This model tracks PostgreSQL tables used to implement Bag many2many
    relations.
    """
...
class IrModelData(models.Model):
    """Holds external identifier keys for records in the database.
       This has two main uses:
           ...
           * allows tracking the origin of data installed by Bag
