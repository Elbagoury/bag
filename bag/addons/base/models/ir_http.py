...
import bag
from bag import api, http, models, tools, SUPERUSER_ID
from bag.exceptions import AccessDenied
from bag.http import request, Response, ROUTING_KEYS
from bag.modules.registry import Registry
from bag.service import security
from bag.tools.json import json_default
from bag.tools.misc import get_lang, submap
from bag.tools.translate import code_translations

_logger = logging.getLogger(__name__)

# see also mimetypes module: https://docs.python.org/3/library/mimetypes.html and bag.tools.mimetypes
...
class IrHttp(models.AbstractModel):
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        for key, val in list(args.items()):
            ...
            try:
            ...
            except (bag.exceptions.AccessError, bag.exceptions.MissingError) as e:
                ...
                if isinstance(e, bag.exceptions.MissingError):
    ...
    def routing_map(self, key=None):
        ...
        installed = registry._init_modules.union(bag.conf.server_wide_modules)
