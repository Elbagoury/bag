...
from bag import api, Command, fields, models
from bag.tools import OrderedSet
from bag.tools.translate import _, code_translations, LazyTranslate
...
class IrFieldsConverter(models.AbstractModel):
    ...
    def for_model(self, model, fromtype=str):
        ...
        callable taking a record-ish (a dictionary representing an bag
        record with values of typetag ``fromtype``) and returning a converted
        records matching what :meth:`bag.osv.orm.Model.write` expects.

        :param model: :class:`bag.osv.orm.Model` for the conversion base
        :param fromtype:
    ...
    def to_field(self, model, field, fromtype=str):
        ...
        :type field: :class:`bag.fields.Field`
