...
from bag.exceptions import MissingError, UserError
from bag.http import Stream, request
from bag.tools import file_open, replace_exceptions
from bag.tools.image import image_process, image_guess_size_from_field_name
from bag.tools.mimetypes import guess_mimetype, get_extension
from bag.tools.misc import verify_limited_field_access_token
...
class IrBinary(models.AbstractModel):
    ...
    def _get_stream_from(
        ...
        """
        Create a :class:bag.http.Stream: from a record's binary field.
    ...
    def _get_image_stream_from(
        ...
        :meth:`~bag.models.BaseModel._get_placeholder_filename` which
        ...
        accordingly. See also :func:`bag.tools.image.image_process`.
