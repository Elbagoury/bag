...
import bag
from bag import api, fields, models, modules, tools, _
from bag.addons.base.models.ir_model import MODULE_UNINSTALL_FLAG
from bag.exceptions import AccessDenied, UserError, ValidationError
from bag.osv import expression
from bag.tools.parse_version import parse_version
from bag.tools.misc import topological_sort, get_flag
from bag.tools.translate import TranslationImporter, get_po_paths
from bag.http import request
from bag.modules import get_module_path
...
class Module(models.Model):
                ...
                with tools.file_open(path, 'rb') as desc_file:
                    ...
                    if doc.startswith(XML_DECLARATION):
                        warnings.warn(
                            ...
                            f"deprecated since Bag 17, {module.name} can just "
                        ...
                        try:
                            ...
                            warnings.warn(
                                ...
                                f"since Bag 17 ({module.name}'s description "
                                f"is not utf-8)",
                                category=DeprecationWarning,
                            )
    ...
    license = fields.Selection([
        ...
        ('OEEL-1', 'Bag OY Edition License v1.0'),
        ('OPL-1', 'Bag Proprietary License v1.0'),
    ...
    to_buy = fields.Boolean('Bag OY Module', default=False)
    ...
    def _button_immediate_function(self, function):
        ...
        try:
            ...
            raise UserError(_("Bag is currently processing a scheduled action.\n"
    ...
    def button_uninstall(self):
        un_installable_modules = set(bag.conf.server_wide_modules) & set(self.mapped('name'))
