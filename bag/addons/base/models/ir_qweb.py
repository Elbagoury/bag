...
QWeb is the primary templating engine used by Bag. It is an XML templating
...
<https://www.bag.com/documentation/master/developer/reference/frontend/qweb.html>`
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
**Values**: name of the allowed bag user group, or preceded by ``!`` for
prohibited groups

The generated code uses ``has_group`` Bag method from ``res.users`` model.
...
from bag import api, models, tools
from bag.modules import registry
from bag.tools import config, safe_eval, pycompat
from bag.tools.constants import SUPPORTED_DEBUGGER, EXTERNAL_ASSET
from bag.tools.safe_eval import assert_valid_codeobj, _BUILTINS, to_opcodes, _EXPR_OPCODES, _BLACKLIST
from bag.tools.json import scriptsafe
from bag.tools.lru import LRU
from bag.tools.misc import str2bool
from bag.tools.image import image_data_uri, FILETYPE_BASE64_MAGICWORD
from bag.http import request
from bag.tools.profiler import QwebTracker
from bag.exceptions import UserError, AccessDenied, AccessError, MissingError, ValidationError

from bag.addons.base.models.assetsbundle import AssetsBundle
from bag.tools.constants import SCRIPT_EXTENSIONS, STYLE_EXTENSIONS, TEMPLATE_EXTENSIONS
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _debug_trace(self, debugger, values):
        ...
        if not debugger:
            ...
            warnings.warn(
                ...
                "since Bag 17.0, keep the value empty and configure the "
    ...
    def _link_to_node(self, path, defer_load=False, lazy_load=False, media=None):
        ...
        if is_js:
            ...
            if is_asset_bundle:
                attributes['onerror'] = "__bagAssetError=1"
