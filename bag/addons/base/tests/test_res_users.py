...
from bag.addons.base.models.res_users import is_selection_groups, get_selection_groups, name_selection_groups
from bag.exceptions import UserError, ValidationError
from bag.http import _request_stack
from bag.tests import Form, TransactionCase, new_test_user, tagged, HttpCase, users
...
class TestUsers(TransactionCase):
    ...
    @mute_logger('bag.sql_db', 'bag.addons.base.models.res_users_deletion')
    ...
    def test_context_get_lang(self):
        ...
        request_patch = patch('bag.addons.base.models.res_users.request', request)
