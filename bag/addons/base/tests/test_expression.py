...
from bag.addons.base.tests.common import SavepointCaseWithUserDemo
from bag.tests.common import BaseCase, TransactionCase
...
class TestExpression(SavepointCaseWithUserDemo, TransactionExpressionCase):
    ...
    def test_10_hierarchy_in_m2m(self):
        ...
        with self.assertLogs('bag.osv.expression'):
    ...
    def test_like_cast(self):
        ...
        with mute_logger('bag.sql_db'), self.assertRaises(psycopg2.Error):
