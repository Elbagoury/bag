...
import bag
from bag.tests import TransactionCase
from bag.tools import file_path, file_open, file_open_temporary_directory
from bag.tools.config import conf, configmanager, _get_default_datadir


IS_POSIX = 'workers' in bag.tools.config.options
ROOT_PATH = bag.tools.config.options['root_path'].removesuffix('/bag')
...
class TestConfigManager(TransactionCase):
    ...
    def setUp(self):
        ...
        self.patch(conf, 'addons_paths', bag.conf.addons_paths)
        self.patch(conf, 'server_wide_modules', bag.conf.server_wide_modules)
    ...
    def test_01_default_config(self):
        ...
        default_values = {
            ...
            'import_partial': '',
            'pidfile': '',
            'addons_path': f'{ROOT_PATH}/bag/addons,{ROOT_PATH}/addons',
            'upgrade_path': '',
    ...
    def test_02_config_file(self):
        values = {
            ...
            'reportgz': True,
            'root_path': f'{ROOT_PATH}/bag',  # blacklist for save, ignored from the config file
    ...
    def test_04_bag16_config_file(self):
        # test that loading the Bag 16.0 generated default config works
