...
from bag.exceptions import AccessDenied, AccessError
from bag.http import _request_stack

import bag
import bag.tools
from bag.tests import common
from bag.service import common as auth, model
from bag.tools import DotDict
...
class TestXMLRPC(common.HttpCase):
    ...
    def test_xmlrpc_defaultdict_marshalling(self):
        ...
        self.patch(self.registry['res.users'], 'context_get',
                   bag.api.model(lambda *_: collections.defaultdict(int)))
