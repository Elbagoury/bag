...
from bag.exceptions import AccessError, ValidationError
from bag.tests import common, tagged
from bag.addons.base.tests.common import TransactionCaseWithUserDemo
from bag.tools import mute_logger, view_validation, safe_eval
from bag.tools.cache import get_cache_key_counter
from bag.addons.base.models import ir_ui_view
...
class ViewCase(TransactionCaseWithUserDemo):
    ...
    def assertInvalid(self, arch, expected_message=None, name='invalid view', inherit_id=False, model='ir.ui.view'):
        with mute_logger('bag.addons.base.models.ir_ui_view'):
    ...
    def assertWarning(self, arch, expected_message=None, name='invalid view', model='ir.ui.view'):
        with self.assertLogs('bag.addons.base.models.ir_ui_view', level="WARNING") as log_catcher:
            self.View.create({
                'name': name,
                'model': model,
                'arch': arch,
