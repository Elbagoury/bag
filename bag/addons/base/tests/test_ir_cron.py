...
from bag.tests.common import TransactionCase, RecordCapturer
from bag.tools import mute_logger
from bag.addons.base.models.ir_cron import MIN_FAILURE_COUNT_BEFORE_DEACTIVATION, MIN_DELTA_BEFORE_DEACTIVATION
    ...
    def test_cron_process_job(self):
        ...
        for cb, curr_failures, trigger, call_count, done_count, fail_count, active in CASES:
            with self.subTest(cb=cb, failure=curr_failures), closing(self.cr.savepoint()):
                ...
                try:
                    with mute_logger('bag.addons.base.models.ir_cron'),\
