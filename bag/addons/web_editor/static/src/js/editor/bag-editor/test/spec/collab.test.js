...
import { BagEditor, parseHTML, setSelection, insertCharsAt } from '../../src/BagEditor.js';
import {
...
const testMultiEditor = async spec => {
    ...
    for (const clientInfo of clientInfosList) {
        ...
        let nextId = 1;
        BagEditor.prototype._generateId = () => 'fake_id_' + nextId++;

        clientInfo.editor = new BagEditor(clientInfo.editable, Object.assign({
            toSanitize: false,
    ...
    BagEditor.prototype._generateId = () => 'fake_concurent_id_' + concurentNextId++;
