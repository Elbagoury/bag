...
import { BagEditor } from '../src/BagEditor.js';
...
export async function testEditor(Editor = BagEditor, spec, options = {}) {
    hasMobileTest = false;
...
export const pasteBagEditorHtml = async (editor, html) => pasteData(editor, html, 'text/bag-editor');
...
export class BasicEditor extends BagEditor {}
