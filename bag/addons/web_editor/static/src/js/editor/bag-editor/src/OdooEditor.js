...
export class BagEditor extends EventTarget {
    constructor(editable, options = {}) {
        ...
        this.options = defaultOptions(
            {
                ...
                // `convertNumericToUnit` as bag-editor utils to avoid this
        ...
        this.editable.classList.add("bag-editor-editable");
    ...
    _onClipboardCopy(clipboardEvent) {
        ...
        const bagHtml = dataHtmlElement.innerHTML.replace(/\uFEFF/g, "");
        const bagText = selection.toString().replace(/\uFEFF/g, "");
        clipboardEvent.clipboardData.setData('text/plain', bagText);
        clipboardEvent.clipboardData.setData('text/html', bagHtml);
        clipboardEvent.clipboardData.setData('text/bag-editor', bagHtml);
    }
    /**
     * @private
     */
    ...
    isSelectionInBlockRoot() {
        ...
        while (
            ...
            !currentNode.classList.contains('bag-editor-editable') &&
    ...
    _onPaste(ev) {
        ...
        const bagEditorHtml = ev.clipboardData.getData('text/bag-editor');
        ...
        } else if (bagEditorHtml) {
            const fragment = parseHTML(this.document, bagEditorHtml);
