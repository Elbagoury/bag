...
import { deduceURLfromText } from "@web_editor/js/editor/bag-editor/src/utils/sanitize";

const { getDeepRange, getInSelection, EMAIL_REGEX, PHONE_REGEX } = BagEditorLib;
...
export class Link extends Component {
    ...
    async _updateState(props) {
        ...
        if (this.state.range) {
            this.$link = this.$link || $(BagEditorLib.getInSelection(this.editable.ownerDocument, 'a'));
