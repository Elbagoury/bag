...
import { closestElement } from "@web_editor/js/editor/bag-editor/src/BagEditor";
...
export class MassMailingWysiwyg extends Wysiwyg {
    ...
    setSnippetsMenuFolded(fold = true) {
        ...
        this.bagEditor.toolbar = this.toolbarEl;
        this.bagEditor.autohideToolbar = !!fold;
    ...
    async getSnippetsMenuClass() {
        ...
        const { MassMailingSnippetsMenu } = await bag.loader.modules.get('@mass_mailing/js/snippets.editor');
