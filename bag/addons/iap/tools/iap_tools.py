...
from bag import exceptions, _
from bag.tools import email_normalize

_logger = logging.getLogger(__name__)

DEFAULT_ENDPOINT = 'https://iap.bag.com'
...
_MAIL_PROVIDERS = {
    ...
    'bk.ru', 'mail.bag.com', 'gmail.con', 'fiu.edu', 'gmal.com', 'useemlikefun.com', 'google.com', 'trbvn.com', 'yopmail.com', 'ya.ru',
...
_MAIL_DOMAIN_BLACKLIST = _MAIL_PROVIDERS | {'bag.com'}
...
def iap_jsonrpc(url, method='call', params=None, timeout=15):
    ...
    try:
        ...
        raise exceptions.AccessError(
            _("An error occurred while reaching %s. Please contact Bag support if this error persists.", url)
        )
