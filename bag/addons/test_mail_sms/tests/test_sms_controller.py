...
from bag.addons.test_mail_sms.tests.test_sms_management import TestSMSActionsCommon
from bag.tests.common import HttpCase, JsonRpcException
...
class TestSmsController(HttpCase, TestSMSActionsCommon):
    ...
    @mute_logger("bag.addons.base.models.ir_http")
    ...
    @mute_logger('bag.addons.base.models.ir_http', 'bag.addons.sms.controllers.main', 'bag.http')
