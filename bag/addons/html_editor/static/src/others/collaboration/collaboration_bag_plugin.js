...
/**
 * @typedef { Object } CollaborationBagShared
 * @property { CollaborationBagPlugin['getPeerMetadata'] } getPeerMetadata
 */

export class CollaborationBagPlugin extends Plugin {
    static id = "collaborationBag";
            ...
            onNotification: async (notification) => {
                ...
                switch (notificationName) {
                    ...
                    case "ptp_disconnect":
                        ...
                        // todo: to implement
                        // this.bagEditor.multiselectionRemove(fromPeerId);
                        break;
