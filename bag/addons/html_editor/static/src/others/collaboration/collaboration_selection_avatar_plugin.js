...
export class CollaborationSelectionAvatarPlugin extends Plugin {
    ...
    static dependencies = ["history", "position", "localOverlay", "collaborationBag"];
    resources = {
        /** Handlers */
    ...
    /**
     * @param {import("./collaboration_bag_plugin").CollaborationSelection} selection
     */
    ...
    drawPeerAvatar(selectionInfo) {
        ...
        const peerMetadata = this.dependencies.collaborationBag.getPeerMetadata(peerId);
        if (!peerMetadata) {
            return;
        }
