...
import { click, manuallyDispatchProgrammaticEvent, press, waitFor } from "@bag/hoot-dom";
 ...
 * @param {string} html
 */
export function pasteBagEditorHtml(editor, html) {
    return pasteData(editor, html, "application/vnd.bag.bag-editor");
}
/**
 * @param {Node} node
 */
