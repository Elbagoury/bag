...
import { expect, getFixture } from "@bag/hoot";
import { queryOne } from "@bag/hoot-dom";
...
export async function setupWysiwyg(props = {}) {
    ...
    const el = /** @type {HTMLElement} **/ (
        queryOne(`${props.iframe ? ":iframe " : ""}.bag-editor-editable`)
    );
    if (content) {
...
export function insertTestHtml(innerHtml) {
    ...
    container.classList.add("bag-editor-editable");
