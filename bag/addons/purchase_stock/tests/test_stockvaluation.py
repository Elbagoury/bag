...
import bag
from bag import fields, exceptions, Command
from bag.tests import Form
from bag.tests.common import TransactionCase, tagged
from bag.addons.account.tests.common import AccountTestInvoicingCommon
from bag.tools import DEFAULT_SERVER_DATETIME_FORMAT
from bag.addons.stock.tests.common import TestStockCommon
...
class TestStockValuationWithCOA(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        old_action_post = bag.addons.account.models.account_move.AccountMove.action_post
        old_create = bag.models.BaseModel.create
        ...
        post_patch = patch('bag.addons.account.models.account_move.AccountMove.action_post', new_action_post)
        create_patch = patch('bag.models.BaseModel.create', new_create)
    ...
    def test_realtime_anglo_saxon_valuation_multicurrency_different_dates(self):
        ...
        def _today(*args, **kwargs):
            return date_po
        patchers = [
            patch('bag.fields.Date.context_today', _today),
        ]
    ...
    def test_average_realtime_with_delivery_anglo_saxon_valuation_multicurrency_different_dates(self):
        ...
        patchers = [
            patch('bag.fields.Date.context_today', _today),
            patch('bag.fields.Datetime.now', _now),
        ]
    ...
    def test_incoming_with_negative_qty(self):
        ...
        # it is negative qty transfer so Bag will create delivery instead of receipt.
