...
from bag.addons.mail.tools import mail_validation
from bag.addons.phone_validation.tools import phone_validation
from bag.exceptions import UserError, AccessError
from bag.osv import expression
from bag.tools.translate import _
from bag.tools import date_utils, email_split, is_html_empty, groupby, parse_contact_from_email, SQL
from bag.tools.misc import get_lang
...
PLS_COMPUTE_BATCH_STEP = 50000  # bag.models.PREFETCH_MAX = 1000 but larger cluster can speed up global computation
