...
from bag.addons.crm.models.crm_lead import PARTNER_ADDRESS_FIELDS_TO_SYNC
from bag.addons.mail.tests.common import MailCase, mail_new_test_user
...
from bag.fields import Datetime
from bag import models, tools
...
class TestLeadConvertCommon(TestCrmCommon):
    ...
    def setUpClass(cls):
        ...
        cls.crm_lead_dt_patcher = patch('bag.addons.crm.models.crm_lead.fields.Datetime', wraps=Datetime)
