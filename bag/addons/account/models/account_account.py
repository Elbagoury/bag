...
from bag.exceptions import UserError, ValidationError, RedirectWarning
from bag.tools import SQL, Query
...
class AccountAccount(models.Model):
    ...
    def _field_to_sql(self, alias: str, fname: str, query: (Query | None) = None, flush: bool = True) -> SQL:
        ...
        if fname == 'placeholder_code':
            ...
            # see https://github.com/bag/bag/blob/2a3466e8f86bc08594391658e08ba3416fb8307b/bag/models.py#L2222
            return SQL(
                "COALESCE("
