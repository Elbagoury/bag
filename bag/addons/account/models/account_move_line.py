...
from bag import api, fields, models, Command, _
from bag.exceptions import ValidationError, UserError
from bag.osv import expression
from bag.tools import frozendict, format_date, float_compare, format_list, Query
from bag.tools.sql import create_index, SQL
from bag.addons.web.controllers.utils import clean_action

from bag.addons.account.models.account_move import MAX_HASH_VERSION
...
class AccountMoveLine(models.Model):
    ...
    def _prepare_move_line_residual_amounts(self, aml_values, counterpart_currency, shadowed_aml_values=None, other_aml_values=None):
        ...
        def get_bag_rate(aml, other_aml, currency):
        ...
        if currency == company_currency \
            ...
            rate = get_bag_rate(aml, other_aml, counterpart_currency)
