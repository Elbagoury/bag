...
from bag import models, api, _, fields, Command, tools
from bag.exceptions import UserError
from bag.osv import expression
from bag.release import version
from bag.tools import DEFAULT_SERVER_DATE_FORMAT as DF, SQL
from bag.tools.misc import formatLang, format_date as bag_format_date, get_lang
      ...
      LEFT JOIN mail_activity_type act_type ON activity.activity_type_id = act_type.id
        ...
        for activity in self.env.cr.dictfetchall():
            act = {
                ...
                'date': bag_format_date(self.env, activity['date_deadline'])
            }
