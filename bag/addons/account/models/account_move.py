...
from bag import api, fields, models, _, Command, SUPERUSER_ID, modules, tools
from bag.tools.sql import column_exists, create_column
from bag.addons.account.tools import format_structured_reference_iso
from bag.exceptions import UserError, ValidationError, AccessError, RedirectWarning
from bag.osv import expression
from bag.tools.misc import clean_context
...
from bag.tools.mail import email_re, email_split, is_html_empty
...
class AccountMove(models.Model):
    ...
    quick_edit_total_amount = fields.Monetary(
        ...
        help='Use this field to encode the total amount of the invoice.\n'
             'Bag will automatically create one invoice line with default values to match it.',
    )
    ...
    def _get_invoice_reference_bag_invoice(self):
        """ This computes the reference based on the Bag format.
    ...
    def _get_invoice_reference_bag_partner(self):
        """ This computes the reference based on the Bag format.
    ...
    def _get_fields_to_copy_recurring_entries(self, values):
        ...
        values.update({
            ...
            'invoice_user_id': self.invoice_user_id.id,  # otherwise user would be BagBot
        })
