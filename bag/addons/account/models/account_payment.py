# -*- coding: utf-8 -*-
from bag import models, fields, api, _, Command
from bag.exceptions import UserError, ValidationError
from bag.tools.misc import format_date, formatLang
from bag.tools import create_index
...
class AccountPayment(models.Model):
    ...
    payment_method_line_id = fields.Many2one('account.payment.method.line', string='Payment Method',
        ...
        help="Manual: Pay or Get paid by any method outside of Bag.\n"
