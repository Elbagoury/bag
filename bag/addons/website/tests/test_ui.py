...
from bag.addons.web_editor.controllers.main import Web_Editor


@bag.tests.tagged('-at_install', 'post_install')
class TestUiCustomizeTheme(bag.tests.HttpCase):
...
class TestUiHtmlEditor(HttpCaseWithUserDemo):
    ...
    def test_code_editor_usable(self):
        ...
        url = '/bag/action-website.website_preview'
        self.start_tour(url, 'website_code_editor_usable', login='admin')


@bag.tests.tagged('external', '-standard', '-at_install', 'post_install')
...
@bag.tests.tagged('-at_install', 'post_install')
class TestUiTranslate(bag.tests.HttpCase):
...
class TestUi(bag.tests.HttpCase):

    def test_01_admin_tour_homepage(self):
        self.start_tour("/bag", 'homepage', login='admin')
    ...
    def test_10_website_conditional_visibility(self):
        ...
        self.start_tour('/bag', 'conditional_visibility_2', login='admin')
    ...
    def test_19_website_page_options(self):
        self.start_tour("/bag", "website_page_options", login="admin")
    ...
    def test_21_website_start_cloned_snippet(self):
        self.start_tour('/bag', 'website_start_cloned_snippet', login='admin')

    def test_22_website_gray_color_palette(self):
        self.start_tour('/bag', 'website_gray_color_palette', login='admin')
    ...
    def test_26_website_media_dialog_icons(self):
        self.env.ref('website.default_website').write({
            'social_twitter': 'https://twitter.com/Bag',
            'social_facebook': 'https://www.facebook.com/Bag',
            'social_linkedin': 'https://www.linkedin.com/company/bag',
            'social_youtube': 'https://www.youtube.com/user/OpenERPonline',
            'social_github': 'https://github.com/bag',
            'social_instagram': 'https://www.instagram.com/explore/tags/bag/',
            'social_tiktok': 'https://www.tiktok.com/@bag',
        })
        self.start_tour("/", 'website_media_dialog_icons', login='admin')

    def test_27_website_clicks(self):
        self.start_tour('/bag', 'website_click_tour', login='admin')
