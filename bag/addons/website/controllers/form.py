...
from bag import http, SUPERUSER_ID
from bag.addons.base.models.ir_qweb_fields import nl2br, nl2br_enclose
from bag.http import request
from bag.tools import plaintext2html
from bag.exceptions import AccessDenied, ValidationError, UserError
from bag.tools.misc import hmac, consteq
