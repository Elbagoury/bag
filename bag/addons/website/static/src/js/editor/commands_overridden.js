...
import { UNMERGEABLE_SELECTORS } from "@web_editor/js/editor/bag-editor/src/utils/sanitize";
 ...
 */
HTMLElement.prototype.oDeleteBackwardBagEditor = HTMLElement.prototype.oDeleteBackward;
HTMLElement.prototype.oDeleteBackward = function (offset, alreadyMoved = false, offsetLimit) {
    ...
    this.oDeleteBackwardBagEditor(...arguments);
};
