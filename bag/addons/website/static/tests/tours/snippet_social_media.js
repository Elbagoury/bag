...
registerWebsitePreviewTour('snippet_social_media', {
    ...
    ...addNewSocialNetwork(9, 8, 'https://instagr.am/bag.official/'),
    {
        ...
        trigger: ":iframe .s_social_media" +
                 ...
                 ":has(a:eq(8)[href='https://instagr.am/bag.official/']:has(i.fa-instagram))",
    },
    ...
    },
    {
        ...
        run: "edit https://instagram.com/bag.official/ && click body",
    },
    ...preventRaceConditionStep,
    ...clickOnSave(),
    ...clickOnEditAndWaitEditMode(),
