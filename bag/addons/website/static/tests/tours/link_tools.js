...
import { boundariesIn, setSelection, nodeSize } from '@web_editor/js/editor/bag-editor/src/utils/utils';
...
registerWebsitePreviewTour('link_tools', {
    ...
    {
        content: "Type the link URL bag.com",
    ...
    clickOnImgStep,
    {
        ...
        trigger: ':iframe #wrap .s_text_image a[href="http://bag.com"]:contains("bag.com")',
        run() {
    ...
    },
    {
        ...
        trigger: ':iframe .popover:contains("http://bag.com") a .fa-chain-broken',
        run: 'click',
    },
    {
        content: "Check that the link was removed",
        trigger: ':iframe #wrap .s_text_image p:contains("Go to bag:"):not(:has(a))',
    },
    // Recreate the link.
    {
    ...
    {
        content: "Click on the newly created link",
        trigger: ':iframe .s_text_image a[href="http://bag.com"]:contains("bag.com")',
        run: "click",
    },
    {
        content: "Change content (editing the label input) to bag website_2",
        trigger: '#o_link_dialog_label_input:value(bag.com)',
        run: 'edit bag website_2',
    },
    {
        content: "Change content (editing the DOM) to bag website",
        trigger: ':iframe .s_text_image a[href="http://bag.com"]:contains("bag website_2")',
        run: 'editor bag website',
    },
    clickOnImgStep,
    {
        content: "Click again on the link",
        trigger: ':iframe .s_text_image a[href="http://bag.com"]:contains("bag website")',
        run: "click",
    },
    {
        content: "Check that the label input contains the new content",
        trigger: '#o_link_dialog_label_input:value(bag website)',
    },
    {
    ...
    ...clickOnEditAndWaitEditMode(),
    {
        content: "The new link content should be bag website and url bag.be",
        trigger: ':iframe .s_text_image a[href="http://bag.be"]:contains("bag website")',
        run: "click",
    },
    {
        content: "The new link content should be bag website and url bag.be",
    ...
    ...clickOnSave(),
    {
        ...
        trigger: ':iframe .s_text_image a.btn.btn-secondary[href="http://bag.be"]:contains("bag website")',
    },
    // 4. Add link on image.
    ...clickOnEditAndWaitEditMode(),
    ...insertSnippet({
    ...
    },
    {
        ...
        // TODO: remove && click
        run: "edit bag.com && click(we-title:contains(Your URL))",
    },
    {
    ...
    },
    {
        ...
        trigger: ':iframe .popover div a:contains("http://bag.com")',
    },
    ...clickOnSave(),
    {
    ...
    clickOnElement("card's text", ":iframe header .s_mega_menu_cards span"),
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run: "edit https://www.bag.com",
    },
    {
        content: "Check nothing is lost",
        trigger: ":iframe header .s_mega_menu_cards a[href='https://www.bag.com']:has(img):has(h4):has(span)",
    },
    ...
    {
        content: "Select text",
        trigger: ':iframe #wrap .s_text_image p:contains(bag.com)',
        run() {
    ...
    clickOnImgStep,
    {
        ...
        trigger: ":iframe .s_text_image p a[href='http://bag.com']:contains('bag.com')",
    },
    {
        content: "Click on link to open the link tools",
        trigger: ":iframe .s_text_image p a[href='http://bag.com']",
        run: "click",
    },
    // 8. Check that http links are not coerced to https and vice-versa.
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run() {
            // TODO: update the tour to use helpers.edit("https://bag.com")
            // To see what happens with edit, add `pause:true` to the previous step
            // and type yourself https://bag.com in #o_link_dialog_url_input
            // The label will be ohttps://
            this.anchor.value = "https://bag.com";
            this.anchor.dispatchEvent(new InputEvent("input", { bubbles: true }));
        }
    },
    {
        content: "Check that link was updated",
        trigger: ":iframe .s_text_image p a[href='https://bag.com']:contains('bag.com')",
    },
    {
    ...
    },
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run() {
            // TODO: update the tour to use helpers.edit("http://bag.com")
            this.anchor.value = "http://bag.com";
            this.anchor.dispatchEvent(new InputEvent("input", { bubbles: true }));
        }
    },
    {
    ...
    // TODO this step which was added by https://github.com/bag/bag/commit/9fc283b514d420fdfd66123845d9ec3563572692
