...

{
    ...
    'website': 'https://www.bag.com/app/website',
    'version': '1.0',
    'depends': [
        'digest',
        'web',
    ...
    'data': [
        ...
        'views/snippets/s_mega_menu_bag_menu.xml',
    ...
    'assets': {
        'web.assets_frontend': [
            ...
            'website/static/src/libs/zoombag/zoombag.scss',
            'website/static/src/scss/website.scss',
            'website/static/src/scss/website_controller_page.scss',
            'website/static/src/scss/website.ui.scss',
            'website/static/src/libs/zoombag/zoombag.js',
        ...
        'website.assets_wysiwyg': [
            ...
            'website/static/src/js/editor/bag_editor.js',
        ],
