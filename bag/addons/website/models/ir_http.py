...
from bag.osv.expression import FALSE_DOMAIN
from bag.addons.base.models.ir_http import EXTENSION_TO_WEB_MIMETYPES
from bag.addons.http_routing.models import ir_http
...
def get_request_website():
    ...
    ```
    from bag.addons.website.models import ir_http
...
class Http(models.AbstractModel):
    ...
    def _get_translation_frontend_modules_name(cls):
        ...
        installed = request.registry._init_modules.union(bag.conf.server_wide_modules)
