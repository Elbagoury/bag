...
from bag.addons.website.models.website import Website
import bag.tests
...
class TestWebsiteSession(HttpCaseWithUserDemo):
    ...
    def test_02_inactive_session_lang(self):
        ...
        current_website_id = self.env["website"]._get_current_website_id(bag.tests.HOST)
        self.env["website"].browse(current_website_id).domain = bag.tests.HOST
