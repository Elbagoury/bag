...
Bag is an <a href="https://www.bag.com/app/ecommerce">Open Source eCommerce</a>
...
Bag's unique *'edit inline'* and building blocks approach makes product pages
...
Bag's upselling algorythm allows you to show visitors similar but more
...
Get a clear visibility of your sales funnel. Bag's Google Analytics trackers
are configured by default to track all kind of events related to shopping
carts, call-to-actions, etc.

As Bag marketing tools (mass mailing, campaigns, etc) are also linked with
Google Analytics, you get a complete view of your business.

Target New Markets
------------------

Get your website translated in multiple languages with no effort. Bag proposes
...
SEO tools are ready to use, with no configuration required. Bag suggests
...
Create new landing pages easily with the Bag inline editing feature. Send
...
Benefit from the power of Bag, in your online store: a powerfull tax engine,
...
Everything is integrated with Bag. No pain, real time.
