...
from bag import api, fields, Command, models, _
from bag.exceptions import UserError, ValidationError
from bag.tools import email_split, float_repr, float_round, is_html_empty
...
class HrExpense(models.Model):
    ...
    def _compute_currency_rate(self):
        """
            We want the default bag rate when the following change:
