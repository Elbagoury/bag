...
from bag.tools.pdf import BagPdfFileReader, BagPdfFileWriter
    ...
    def _render_qweb_pdf_prepare_streams(self, report_ref, data, res_ids=None):
        ...
        if report.report_name == 'hr_expense.report_expense_sheet':
            ...
            for expense_sheet in expense_sheets:
                ...
                expense_report = BagPdfFileReader(stream, strict=False)
                output_pdf = BagPdfFileWriter()
                ...
                for attachment in attachments:
                    ...
                    attachment_reader = BagPdfFileReader(attachment_stream, strict=False)
