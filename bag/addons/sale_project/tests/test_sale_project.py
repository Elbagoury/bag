...
from bag.tests import Form, HttpCase, new_test_user, tagged
...
class TestSaleProject(HttpCase, TestSaleProjectCommon):
    ...
    def test_task_create_sol_ui(self):
        self.start_tour('/bag', 'task_create_sol_tour', login='admin')

    def test_project_create_sol_ui(self):
        self.start_tour('/bag', 'project_create_sol_tour', login='admin')
