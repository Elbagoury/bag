...
from bag.addons.website_slides.tests import common
from bag.exceptions import AccessError
from bag.tests import tagged, HttpCase
...
class TestAccess(common.SlidesCase):
    ...
    @mute_logger('bag.models', 'bag.addons.base.models.ir_rule')
...
class TestAccessFeatures(common.SlidesCase):
    ...
    @mute_logger('bag.models.unlink', 'bag.addons.base.models.ir_rule', 'bag.addons.base.models.ir_model')
...
class TestReview(common.SlidesCase, HttpCase):
    ...
    def test_channel_multiple_reviews(self):
        ...
        self.assertIn("bag.exceptions.ValidationError", res2.text)
