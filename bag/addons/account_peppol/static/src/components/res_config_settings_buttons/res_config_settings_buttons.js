...
import { Component, markup, useState } from "@bag/owl";
...
class PeppolSettingsButtons extends Component {
    ...
    showConfirmation(warning, methodName) {
        ...
        const confirmMessage = _t("You will not be able to send or receive Peppol documents in Bag anymore. Are you sure you want to proceed?");
    ...
    migrate() {
        this.showConfirmation(
            "This will migrate your Peppol registration away from Bag. A migration key will be generated. \
