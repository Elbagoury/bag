...
from bag import _, api, fields, models, modules, tools
from bag.addons.account_edi_proxy_client.models.account_edi_proxy_user import AccountEdiProxyError
from bag.addons.account_peppol.tools.demo_utils import handle_demo
from bag.exceptions import UserError
from bag.tools import split_every
...
class AccountEdiProxyClientUser(models.Model):
    ...
    def _get_proxy_urls(self):
        ...
        urls['peppol'] = {
            'prod': 'https://peppol.api.bag.com',
            'test': 'https://peppol.test.bag.com',
            'demo': 'demo',
        }
        return urls
    ...
    def _peppol_register_sender_as_receiver(self):
        ...
        # but we need the field for future in case the user decided to migrate away from Bag
