...
class TestUi(HttpCaseWithUserDemo):
    ...
    def test_01_admin_widget_x2many(self):
        ...
        self.start_tour("/bag/action-test_new_api.action_discussions",
            'widget_x2many', login="admin", timeout=120)


@bag.tests.tagged('-at_install', 'post_install')
class TestUiTranslation(bag.tests.HttpCase):

    @mute_logger('bag.sql_db', 'bag.http')
    def test_01_sql_constraints(self):
        ...
        self.start_tour("/bag/action-test_new_api.action_categories",
