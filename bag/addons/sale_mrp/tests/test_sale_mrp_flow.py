...
from bag.addons.stock_account.tests.test_anglo_saxon_valuation_reconciliation_common import ValuationReconciliationTestCommon
from bag.tests import common, Form
from bag.exceptions import UserError
from bag.tools import mute_logger, float_compare
...
class TestSaleMrpFlow(TestSaleMrpFlowCommon):
    ...
    @mute_logger('bag.tests.common.onchange')
