...
import { CellErrorType, EvaluationError } from "@bag/o-spreadsheet";
import { _t } from "@web/core/l10n/translation";

/**
 * @typedef {import("./bag_data_provider").BagDataProvider} BagDataProvider
...
export class LoadableDataSource {
    /**
     * @param {Object} param0
     * @param {BagDataProvider} param0.bagDataProvider
     */
    constructor({ bagDataProvider }) {
        /** @protected */
    ...
    get _orm() {
        return this.bagDataProvider.orm;
    }

    get serverData() {
        return this.bagDataProvider.serverData;
    }
    ...
    async load(params) {
        if (params && params.reload) {
            this.bagDataProvider.cancelPromise(this._loadPromise);
            this._loadPromise = undefined;
        }
        if (!this._loadPromise) {
            ...
            await this.bagDataProvider.notifyWhenPromiseResolves(this._loadPromise);
        }
 ...
 * @param {string} model
 * @returns {Promise<import("@spreadsheet").BagFields>}
 */
