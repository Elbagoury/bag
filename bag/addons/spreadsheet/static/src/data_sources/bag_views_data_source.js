...
/**
 * @typedef {import("@spreadsheet").BagField} BagField
 * @typedef {import("@spreadsheet").BagFields} BagFields
 */

/**
 * @typedef {Object} BagModelMetaData
 * @property {string} resModel
 * @property {BagFields} [fields]
 *
 * @typedef {Object} BagModelSearchParams
 * @property {Object} context
 * @property {Array<string>} domain
 */

export class BagViewsDataSource extends LoadableDataSource {
    /**
     * @override
     * @param {Object} services
     * @param {Object} params
     * @param {BagModelMetaData} params.metaData
     * @param {Object} params.searchParams
     */
    constructor(services, params) {
        super(services);
        /** @type {BagModelMetaData} */
    ...
    /**
     * @returns {BagFields} List of fields
     */
    getFields() {
     ...
     * @returns {BagField | undefined} Field
     */
    getField(field) {
        this._assertMetaDataLoaded();
