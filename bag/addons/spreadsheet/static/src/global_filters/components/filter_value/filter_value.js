...
import { Component, onWillStart } from "@bag/owl";
import { components } from "@bag/o-spreadsheet";
...
export class FilterValue extends Component {
    ...
    setup() {
        ...
        onWillStart(async () => {
            ...
            try {
                const bagDataProvider = this.props.model.config.custom.bagDataProvider;
                await getFields(bagDataProvider.serverData, this.filter.modelName);
                this.isValid = true;
            } catch (e) {
