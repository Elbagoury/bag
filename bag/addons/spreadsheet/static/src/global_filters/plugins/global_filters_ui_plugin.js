...
export class GlobalFiltersUIPlugin extends BagUIPlugin {
    ...
    constructor(config) {
        ...
        this.bagDataProvider = config.custom.bagDataProvider;
        /**
        ...
        switch (filter.type) {
            ...
            case "relation":
                ...
                if (!this.recordsDisplayName[filter.id]) {
                    ...
                    this.bagDataProvider.notifyWhenPromiseResolves(promise);
                    return [[{ value: "" }]];
                }
