...
import { AbstractChart, CommandResult } from "@bag/o-spreadsheet";
 ...
 *
 * @typedef BagChartDefinitionDataSource
 * @property {MetaData} metaData
 * @property {SearchParams} searchParams
 *
 */

export class BagChart extends AbstractChart {
    /**
     * @param {BagChartDefinition} definition
    ...
    static getDefinitionFromContextCreation() {
        throw new Error("It's not possible to convert an Bag chart to a native chart");
    }

    /**
     * @returns {BagChartDefinitionDataSource}
     */
