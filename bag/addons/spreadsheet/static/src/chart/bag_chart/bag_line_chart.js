...
export class BagLineChart extends BagChart {
...
chartRegistry.add("bag_line", {
    match: (type) => type === "bag_line",
    createChart: (definition, sheetId, getters) => new BagLineChart(definition, sheetId, getters),
    getChartRuntime: createBagChartRuntime,
    validateChartDefinition: (validator, definition) =>
        BagLineChart.validateChartDefinition(validator, definition),
    transformDefinition: (definition) => BagLineChart.transformDefinition(definition),
    getChartDefinitionFromContextCreation: () => BagLineChart.getDefinitionFromContextCreation(),
    name: _t("Line"),
});
...
function createBagChartRuntime(chart, getters) {
    ...
    for (const index in datasets) {
        ...
        if (chart.fillArea) {
            ...
            // use the transparency of Bag to keep consistency
