...
export class BagBarChart extends BagChart {
...
chartRegistry.add("bag_bar", {
    match: (type) => type === "bag_bar",
    createChart: (definition, sheetId, getters) => new BagBarChart(definition, sheetId, getters),
    getChartRuntime: createBagChartRuntime,
    validateChartDefinition: (validator, definition) =>
        BagBarChart.validateChartDefinition(validator, definition),
    transformDefinition: (definition) => BagBarChart.transformDefinition(definition),
    getChartDefinitionFromContextCreation: () => BagBarChart.getDefinitionFromContextCreation(),
    name: _t("Bar"),
});
