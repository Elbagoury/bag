...
import { BagViewsDataSource } from "@spreadsheet/data_sources/bag_views_data_source";
import { EvaluationError } from "@bag/o-spreadsheet";
...
export class ListDataSource extends BagViewsDataSource {
    /**
     * @override
