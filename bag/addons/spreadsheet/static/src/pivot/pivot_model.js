...
import { helpers, constants, EvaluationError, SpreadsheetPivotTable } from "@bag/o-spreadsheet";
...
/**
 * @typedef {import("@bag/o-spreadsheet").PivotTableColumn} PivotTableColumn
 * @typedef {import("@bag/o-spreadsheet").PivotTableRow} PivotTableRow
 ...
 */
export class BagPivotModel extends PivotModel {
    /**
     * @param {import("@web/env").BagEnv} env
     * @param {import("@spreadsheet").BagPivotModelParams} params
    ...
    /**
     * Get the Bag domain corresponding to the given domain
     * @param {PivotDomain} domain
     */
    ...
    /**
     * @param {import("@bag/o-spreadsheet").PivotDimension} dimension
