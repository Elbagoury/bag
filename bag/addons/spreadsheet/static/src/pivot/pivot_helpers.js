...
import { EvaluationError, helpers } from "@bag/o-spreadsheet";
 ...
 * @typedef {import("@bag/o-spreadsheet").Granularity} Granularity
 * */
 ...
 * @param {Record<string, BagField | undefined>} allFields
 * @param {string} groupFieldString
 * @returns {{field: BagField, granularity: Granularity, isPositional: boolean, dimensionWithGranularity: string}}
 */
