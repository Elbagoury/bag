...
import { NO_RECORD_AT_THIS_POSITION, BagPivotModel } from "./pivot_model";
import { EvaluationError, PivotRuntimeDefinition, registries, helpers } from "@bag/o-spreadsheet";
import { LOADING_ERROR } from "@spreadsheet/data_sources/data_source";
import { omit } from "@web/core/utils/objects";
import { BagPivotLoader } from "./bag_pivot_loader";
...
/**
 * @typedef {import("@bag/o-spreadsheet").FunctionResultObject} FunctionResultObject
 * @typedef {import("@bag/o-spreadsheet").PivotMeasure} PivotMeasure
 * @typedef {import("@bag/o-spreadsheet").PivotDomain} PivotDomain
 * @typedef {import("@bag/o-spreadsheet").PivotDimension} PivotDimension
 * @typedef {import("@bag/o-spreadsheet").PivotCoreMeasure} PivotCoreMeasure
 * @typedef {import("@spreadsheet").WebPivotModelParams} WebPivotModelParams
 * @typedef {import("@spreadsheet").BagPivot<BagPivotRuntimeDefinition>} IPivot
 * @typedef {import("@spreadsheet").BagFields} BagFields
 * @typedef {import("@spreadsheet").BagPivotCoreDefinition} BagPivotCoreDefinition
 * @typedef {import("@spreadsheet").SortedColumn} SortedColumn
 * @typedef {import("@spreadsheet").BagGetters} BagGetters
 * @typedef {import("@spreadsheet/data_sources/bag_data_provider").BagDataProvider} BagDataProvider
 */

/**
 * @implements {IPivot}
 */
export class BagPivot {
    /**
     *
     * @override
     * @param {Object} services Services (see DataSource)
     * @param {Object} params
     * @param {BagPivotCoreDefinition} params.definition
     * @param {BagGetters} params.getters
     */
    constructor(services, { definition, getters }) {
        /** @type {"ODOO"} */
        this.type = "ODOO";

        /** @type {BagPivotCoreDefinition} @protected */
        this.coreDefinition = definition;

        this.needsReevaluation = false;

        /** @type {BagPivotRuntimeDefinition | undefined} @protected */
        this.runtimeDefinition = undefined;

        /** @type {BagPivotModel | undefined} @protected */
        this.model = undefined;

        /** @type {BagGetters} @protected */
        this.getters = getters;

        /** @protected */
        this.loader = new BagPivotLoader(services.bagDataProvider, this._load.bind(this));

        /** @type {BagFields | undefined} @protected */
        this._fields = undefined;

        /** @protected @type {BagDataProvider}*/
        this.bagDataProvider = services.bagDataProvider;
    ...
    /**
     * @param {BagPivotCoreDefinition} nextDefinition
     */
    onDefinitionChange(nextDefinition) {
        ...
        if (
            ...
            if (
                ...
                this.coreDefinition = nextDefinition;
                const runtimeDefinition = new BagPivotRuntimeDefinition(
                    this.coreDefinition,
                    this.getFields()
                );
    ...
    async createModelAndDefinition() {
        ...
        const definition = new BagPivotRuntimeDefinition(this.coreDefinition, this.getFields());
        const model = new BagPivotModel(
            { _t },
            {
            ...
            {
                orm: this.bagDataProvider.orm,
                serverData: this.bagDataProvider.serverData,
            }
        );
    ...
    /**
     * @param {import("@bag/o-spreadsheet").Maybe<FunctionResultObject>[]} args
     *
     * @returns {PivotDomain}
     */
...
export class BagPivotRuntimeDefinition extends PivotRuntimeDefinition {
    /**
     * @param {BagPivotCoreDefinition} definition
     * @param {BagFields} fields
     */
