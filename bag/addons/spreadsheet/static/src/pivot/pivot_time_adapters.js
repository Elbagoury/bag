...
import { registries, helpers, constants } from "@bag/o-spreadsheet";
...
pivotTimeAdapterRegistry.add("week", falseHandlerDecorator(bagWeekAdapter));
pivotTimeAdapterRegistry.add("month", falseHandlerDecorator(bagMonthAdapter));
pivotTimeAdapterRegistry.add("quarter", falseHandlerDecorator(bagQuarterAdapter));

extendSpreadsheetAdapter("day", bagDayAdapter);
extendSpreadsheetAdapter("year", bagNumberDateAdapter);
extendSpreadsheetAdapter("day_of_month", bagNumberDateAdapter);
extendSpreadsheetAdapter("day", bagDayAdapter);
extendSpreadsheetAdapter("iso_week_number", bagNumberDateAdapter);
extendSpreadsheetAdapter("month_number", bagNumberDateAdapter);
extendSpreadsheetAdapter("quarter_number", bagNumberDateAdapter);
extendSpreadsheetAdapter("day_of_week", bagDayOfWeekAdapter);
extendSpreadsheetAdapter("hour_number", bagHourNumberAdapter);
extendSpreadsheetAdapter("minute_number", bagMinuteNumberAdapter);
extendSpreadsheetAdapter("second_number", bagSecondNumberAdapter);
