...
from bag.tests import tagged, get_db_name, new_test_user, HttpCase
...
class TestTOTP(TestTOTPMixin, HttpCase):
    ...
    def test_totp(self):
        # 1. Enable 2FA
        self.start_tour('/bag', 'totp_tour_setup', login='test_user')
    ...
    def test_totp_administration(self):
        ...
        self.start_tour('/bag', 'totp_admin_disables', login='admin')
        self.start_tour('/', 'totp_login_disabled', login=None)
