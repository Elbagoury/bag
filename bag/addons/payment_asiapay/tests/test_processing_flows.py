...
from bag.addons.payment_asiapay.controllers.main import AsiaPayController
...
class TestProcessingFlows(AsiaPayCommon, PaymentHttpCommon):
    ...
    @mute_logger('bag.addons.payment_asiapay.controllers.main')
    def test_webhook_notification_triggers_processing(self):
        ...
        with patch(
            'bag.addons.payment_asiapay.controllers.main.AsiaPayController.'
