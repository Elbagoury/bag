...
from bag.tools import date_utils, groupby as groupbyelem
from bag.osv.expression import AND, FALSE_DOMAIN

from bag.addons.portal.controllers.portal import CustomerPortal, pager as portal_pager
