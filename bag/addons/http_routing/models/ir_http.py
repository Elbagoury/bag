...
import bag
from bag import api, models, exceptions, tools, http
from bag.addons.base.models import ir_http
from bag.addons.base.models.ir_http import RequestUID
from bag.addons.base.models.ir_qweb import keep_query, QWebException
from bag.addons.base.models.res_lang import LangData
from bag.exceptions import AccessError, MissingError
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        if request.is_frontend_multilang:
            ...
            if request.httprequest.method in ('GET', 'HEAD'):
                ...
                except bag.exceptions.MissingError:
