...
from bag.tools import exception_to_unicode
from bag.tools.translate import _
from bag.exceptions import MissingError
...
class EventMailScheduler(models.Model):
    ...
    configuration allowing to send emails on events since Bag 9. A cron exists
