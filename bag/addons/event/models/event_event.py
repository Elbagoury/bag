...
from bag import _, api, Command, fields, models, tools
...
from bag.tools import format_date, format_datetime, format_time, frozendict
from bag.tools.mail import is_html_empty, html_to_inner_content
from bag.tools.misc import formatLang
from bag.tools.translate import html_translate
...
class EventEvent(models.Model):
    ...
    def get_kiosk_url(self):
        return self.get_base_url() + "/bag/registration-desk"
    ...
    def _get_printing_sponsor_text(self):
        ...
        return sponsor_text or "Powered by Bag"
