...
from bag.addons.event.tests.common import EventCase
from bag.addons.mail.tests.common import MockEmail
from bag.tests import tagged, users, warmup
...
class TestMailSchedule(EventCase, MockEmail, CronMixinCase):
    ...
    @mute_logger('bag.addons.event.models.event_mail')
    @users('user_eventmanager')
    ...
    @mute_logger(
        'bag.addons.event.models.event_mail',
        'bag.addons.event.models.event_mail_registration',
        'bag.addons.event.models.event_registration',
    )
