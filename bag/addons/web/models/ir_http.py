...
import bag
from bag import api, models, fields
from bag.http import request, DEFAULT_MAX_CONTENT_LENGTH
from bag.tools import ormcache, config
...
class Http(models.AbstractModel):
    ...
    def session_info(self):
        ...
        version_info = bag.service.common.exp_version()
        ...
        mods = bag.conf.server_wide_modules or []
        if request.db:
        ...
        session_info = {
            ...
            "support_url": "https://www.bag.com/buy",
            "name": user.name,
            "username": user.login,
