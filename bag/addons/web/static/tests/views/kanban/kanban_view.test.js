import { after, beforeEach, expect, test } from "@bag/hoot";
import {
    click,
    dblclick,
    drag,
...
import { Deferred, advanceFrame, animationFrame, runAllTimers, tick } from "@bag/hoot-mock";
import { Component, onRendered, onWillRender, xml } from "@bag/owl";
import {
    MockServer,
    clickKanbanLoadMore,
    clickModalButton,
...
test("quick create record: cancel when modal is opened", async () => {
    ...
    // Check bag/bag#61981 for more details.
