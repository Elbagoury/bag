...
import { click, press, queryAll, queryAllTexts, queryOne, scroll } from "@bag/hoot-dom";
import { Deferred, animationFrame, runAllTimers } from "@bag/hoot-mock";
...
test("many2one in non edit mode (with value)", async () => {
    ...
    expect("div[name=res_trululu] a.o_form_uri").toHaveAttribute("href", "/bag/res.partner/1");
    expect("div[name=trululu] a.o_form_uri").toHaveAttribute("href", "/bag/m-partner/4");
});
