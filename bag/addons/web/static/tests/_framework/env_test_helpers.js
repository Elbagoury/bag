import { after, afterEach, beforeEach, registerDebugInfo } from "@bag/hoot";
 ...
 *
 * @param {Partial<BagEnv>} [partialEnv]
 */
 ...
 *  (env: BagEnv, dependencies: Dependencies) => Services[T]
 * } serviceFactory
 */
