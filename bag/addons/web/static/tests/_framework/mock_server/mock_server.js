import { before, createJobScopedGetter, expect, getCurrent, registerDebugInfo } from "@bag/hoot";
import { mockFetch, mockWebSocket } from "@bag/hoot-mock";
...
export class MockServer {
    ...
    /** @type {import("@bag/hoot-mock").ServerWebSocket[]} */
    websockets = [];
    ...
    _findAction(id) {
        ...
        if (!actions.length) {
            throw makeServerError({
                errorName: "bag.addons.web.controllers.action.MissingActionError",
