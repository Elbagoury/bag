import { after, expect, getFixture } from "@bag/hoot";
import { click, formatXml, queryAll, queryAllTexts } from "@bag/hoot-dom";
import { animationFrame, Deferred, tick } from "@bag/hoot-mock";
import { Component, onMounted, useSubEnv, xml } from "@bag/owl";
