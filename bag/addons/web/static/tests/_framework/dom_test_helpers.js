import { after, afterEach } from "@bag/hoot";
import {
    check,
    clear,
    click,
...
import { advanceFrame, advanceTime, animationFrame } from "@bag/hoot-mock";
import { hasTouch } from "@web/core/browser/feature_detection";

/**
 * @typedef {import("@bag/hoot-dom").DragHelpers} DragHelpers
 * @typedef {import("@bag/hoot-dom").FillOptions} FillOptions
 * @typedef {import("@bag/hoot-dom").InputValue} InputValue
 * @typedef {import("@bag/hoot-dom").KeyStrokes} KeyStrokes
 * @typedef {import("@bag/hoot-dom").PointerOptions} PointerOptions
 * @typedef {import("@bag/hoot-dom").Position} Position
 * @typedef {import("@bag/hoot-dom").QueryOptions} QueryOptions
 * @typedef {import("@bag/hoot-dom").Target} Target
 *
...
/**
 * @template T
 * @typedef {import("@bag/hoot-dom").MaybePromise<T>} MaybePromise
 */
