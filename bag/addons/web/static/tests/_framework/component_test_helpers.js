import { after, destroy, getFixture } from "@bag/hoot";
import { queryFirst, queryOne } from "@bag/hoot-dom";
import { App, Component, xml } from "@bag/owl";
...
/**
 * @typedef {import("@bag/owl").Component} Component
 *
 * @typedef {import("@web/env").BagEnv} BagEnv
 *
 * @typedef {Parameters<typeof import("@bag/owl").mount>[2]} MountOptions
 *
 ...
 * @template [P=any]
 * @template [E=any]
 * @typedef {import("@bag/owl").ComponentConstructor<P, E>} ComponentConstructor
 */
