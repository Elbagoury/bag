/** @bag-module alias=@web/../tests/mobile/core/action_swiper_tests default=false */

import { Component, onPatched, xml } from "@bag/owl";
...
import { queryFirst, hover } from "@bag/hoot-dom";
import { advanceTime, animationFrame, mockTouch } from "@bag/hoot-mock";
