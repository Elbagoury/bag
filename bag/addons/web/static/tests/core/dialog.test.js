import { destroy, expect, test } from "@bag/hoot";
import { keyDown, keyUp, press, queryAllTexts, queryOne, resize } from "@bag/hoot-dom";
import { animationFrame } from "@bag/hoot-mock";
import { Component, onMounted, useState, xml } from "@bag/owl";
import {
    contains,
    getService,
    makeDialogMockEnv,
