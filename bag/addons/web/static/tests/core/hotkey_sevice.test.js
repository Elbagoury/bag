import { destroy, expect, getFixture, onError, test } from "@bag/hoot";
import { keyDown, keyUp, press, queryAllTexts, queryOne } from "@bag/hoot-dom";
import { animationFrame, mockUserAgent, tick } from "@bag/hoot-mock";
import { Component, useRef, useState, xml } from "@bag/owl";
import {
    contains,
    getService,
    makeMockEnv,
