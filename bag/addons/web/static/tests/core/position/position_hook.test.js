import { before, destroy, expect, getFixture, test } from "@bag/hoot";
import { manuallyDispatchProgrammaticEvent, queryOne, scroll } from "@bag/hoot-dom";
import { Deferred, animationFrame } from "@bag/hoot-mock";
import { Component, xml, useRef, onMounted } from "@bag/owl";
