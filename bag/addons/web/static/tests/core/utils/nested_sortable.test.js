...
import { queryFirst, queryOne, queryRect } from "@bag/hoot-dom";
import { animationFrame } from "@bag/hoot-mock";
import { Component, reactive, useRef, useState, xml } from "@bag/owl";
 ...
 *
 * @param {import("@bag/hoot-dom").Target} from
...
/**
 * @param {import("@bag/hoot-dom").Target} from
 * @param {import("@bag/hoot-dom").Target} to
 */
