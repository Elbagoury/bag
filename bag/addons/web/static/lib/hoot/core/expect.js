 ...
 * }} ExpectOptions
 *
 * @typedef {import("@bag/hoot-dom").Dimensions} Dimensions
 * @typedef {import("@bag/hoot-dom").FormatXmlOptions} FormatXmlOptions
 * @typedef {import("@bag/hoot-dom").QueryRectOptions} QueryRectOptions
 * @typedef {import("@bag/hoot-dom").QueryTextOptions} QueryTextOptions
...
export class Matcher {
     ...
     * @example
     *  expect("header h1").toHaveText(/bag/i);
     */
