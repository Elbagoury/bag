...
/**
 * @typedef {Parameters<typeof import("@bag/owl").mount>[2] & {
 *  className: string | string[];
 *  target?: import("@bag/hoot-dom").Target;
 * }} MountOnFixtureOptions
 *
 * @typedef {{
 *  component: import("@bag/owl").ComponentConstructor;
 *  props: unknown;
 * }} TestRootProps
 */
...
/**
 * @param {App | import("@bag/owl").Component} target
 */
