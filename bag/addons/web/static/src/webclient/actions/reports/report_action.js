...
import { Component, useRef, useSubEnv } from "@bag/owl";
 ...
 * It uses a feature to automatically create links to other bag pages if the selector [res-id][res-model][view-type]
 * is detected.
 */
