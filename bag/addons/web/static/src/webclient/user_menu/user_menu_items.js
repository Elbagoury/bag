import { Component, markup } from "@bag/owl";
...
function documentationItem(env) {
    const documentationURL = "https://www.bag.com/documentation/18.0";
    return {
        type: "item",
        id: "documentation",
...
export function bagAccountItem(env) {
    return {
        type: "item",
        id: "account",
        description: _t("My Bag.com account"),
        callback: () => {
            rpc("/web/session/account")
                ...
                .catch(() => {
                    browser.open("https://accounts.bag.com/account", "_blank");
                });
        },
        sequence: 60,
    };
...
registry
    ...
    .add("bag_account", bagAccountItem)
