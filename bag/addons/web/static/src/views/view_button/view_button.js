...
export class ViewButton extends Component {
    ...
    get hasBigTooltip() {
        return Boolean(bag.debug) || this.clickParams.help;
    }
    ...
    getClassName() {
        ...
        if (this.props.className) {
            for (let cls of this.props.className.split(" ")) {
                if (cls in bagToBootstrapClasses) {
                    cls = bagToBootstrapClasses[cls];
                }
                classNames.push(cls);
