...
import { Component, onWillStart, useEffect, useRef } from "@bag/owl";
...
export class JournalDashboardGraphField extends Component {
    ...
    getLineChartConfig() {
        ...
        const color10 = getColor(3, cookie.get("color_scheme"), "bag");
    ...
    getBarChartConfig() {
        ...
        const color13 = getColor(2, cookie.get("color_scheme"), "bag");
        const color19 = getColor(1, cookie.get("color_scheme"), "bag");
