...
from bag.http import content_disposition, request
from bag.tools import lazy_property, osutil
from bag.tools.misc import xlsxwriter
...
class ExportFormat(object):
    ...
    def from_data(self, fields, columns_headers, rows):
        """ Conversion method from Bag's export data to whatever the
