...
from bag import http, tools, _, release
from bag.exceptions import UserError
from bag.http import request
from bag.tools import replace_exceptions
...
class LivechatController(http.Controller):
    ...
    @http.route('/im_livechat/bag_ui_icons', type='http', auth='none', cors="*")
    def bag_ui_icons(self, **kwargs):
        return http.Stream.from_path('web/static/lib/bag_ui_icons/fonts/bag_ui_icons.woff2').get_response()
