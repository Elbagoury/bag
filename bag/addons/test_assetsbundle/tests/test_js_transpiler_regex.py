...
from bag.tools import URL_RE, ODOO_MODULE_RE
...
class TestJsTranspiler(TransactionCase):
    ...
    def test_correct_ODOO_MODULE_RE(self):
        cases = [
            ...
            '/*@bag-module',
            '/**@bag-module',
            '// @bag-module alias=web.test',
            '/* @bag-module  alias=web.test',
            '/** @bag-module  alias=web.test',
            '/** @bag-module  alias=web.test**/',
            '/* @bag-module  alias=web.test ',
            '/* @bag-module alias=web.test default=false',
            '/* @bag-module alias=web.test default=false ',
            '/* @bag-module alias=web.test default=false**/',
        ]
    ...
    def test_incorrect_ODOO_MODULE_RE(self):
        ...
        cases = [
            '// @bag-modulealias=web.test',
            '/* @bag-module alias=web.testdefault=false',
        ]
