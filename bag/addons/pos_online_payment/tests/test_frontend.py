...
from bag.addons.pos_online_payment.tests.online_payment_common import OnlinePaymentCommon
from bag.addons.account.models.account_payment_method import AccountPaymentMethod
from bag.osv.expression import AND
from bag.addons.point_of_sale.tests.common import archive_products
...
class TestUi(AccountTestInvoicingCommon, OnlinePaymentCommon):
    ...
    def test_invalid_access_token(self):
        ...
        with mute_logger('bag.http'): # Mutes "The provided order or access token is invalid." online payment portal error.
