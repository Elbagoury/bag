...
export class DashboardLoader {
    ...
    _createSpreadsheetModel(snapshot, revisions = [], currency) {
        const bagDataProvider = new BagDataProvider(this.env);
        const model = new Model(
            snapshot,
            {
                custom: { env: this.env, orm: this.orm, bagDataProvider },
                mode: "dashboard",
        ...
        bagDataProvider.addEventListener("data-source-updated", () =>
