...
from bag.addons.sales_team.tests.common import TestSalesMC
from bag.tests.common import users, TransactionCase
...
class TestCornerCases(TransactionCase):
    ...
    def test_unicity(self):
        ...
        with self.assertRaises(exceptions.UserError), mute_logger('bag.sql_db'):
