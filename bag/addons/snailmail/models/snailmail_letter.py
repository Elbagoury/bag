...
from bag import fields, models, api, _
from bag.addons.iap.tools import iap_tools
from bag.exceptions import AccessError, UserError
from bag.tools.pdf import PdfFileReader, PdfFileWriter
from bag.tools.safe_eval import safe_eval

DEFAULT_ENDPOINT = 'https://iap-snailmail.bag.com'
...
class SnailmailLetter(models.Model):
    ...
    def _get_error_message(self, error):
        ...
        if error == 'TRIAL_ERROR':
            ...
            return _('You don\'t have an IAP account registered for this service.<br>Please go to <a href=%s target="new">iap.bag.com</a> to claim your free credits.', link)
