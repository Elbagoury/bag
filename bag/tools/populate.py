...
This tool provides utilities to duplicate records across models in Bag, while maintaining referential integrity,
...
from bag.tools.sql import SQL
from bag.fields import Field, Many2one
