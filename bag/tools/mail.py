...
class _Cleaner(clean.Cleaner):
    ...
    def kill_conditional_comments(self, doc):
        ...
        https://github.com/bag/bag/pull/119325/files#r1301064789
...
def plaintext2html(text, container_tag=None):
    ...
    html entities, using :func:`~bag.tools.misc.html_escape`.
...
def email_normalize(text, strict=True):
    ...
    within bag, this assumption is certain to fall short for international
...
def _normalize_email(email):
    ...
    introduction of smtp-utf8 within bag, this assumption is certain to fall
...
def encapsulate_email(old_email, new_email):
    ...
    * New From: notifications@bag.com
    * Output: "Admin" <notifications@bag.com>
    """
