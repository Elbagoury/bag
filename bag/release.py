...
product_name = 'Bag'
description = 'Bag Server'
long_desc = '''Bag is a complete ERP and CRM. The main features are accounting (analytic
...
author = 'OpenERP S.A.'
author_email = 'info@bag.com'
license = 'LGPL-3'

nt_service_name = "bag-server-" + series.replace('~','-')
