...
from bag.modules.module import get_module_root, MANIFEST_NAMES
from bag.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """ Quickly start the bag server with default options """
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            bag.tools.config['init']['base'] = True
